...
| 点数有效期与扣减顺序 | `docs/user-stories.md` v1.6（每日赠送 1 点 / 1 天有效 / 连续 10 天；收益与充值永久；先扣赠送；金额保留 2 位小数） | US-22、US-23、US-24、E-13、E-14、E-15 一致；UI mock（feat/gift-daily-ui）显示今日赠送（+1）、有效期与连续天数计数。 |
